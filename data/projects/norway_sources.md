# Norway Sources & Citations

## Primary Source Organizations

### Government & Municipal
| Organization | URL | Projects |
|--------------|-----|----------|
| Statsbygg | statsbygg.no | Høyblokken, KA13 |
| Oslo Kommune | oslo.kommune.no | Løren, Ruseløkka, Lilleborg |
| Oslobygg KF | oslobygg.no | Løren, Ruseløkka, Stovner Bad |
| Bærum kommune | baerum.kommune.no | Eikeli, Treklang |
| Asker kommune | asker.kommune.no | Nedre Sem |
| Bergen kommune | bergen.kommune.no | Nøstebukten, Føniks |
| Viken Fylkeskommune | viken.no | Eikeli |
| Miljødirektoratet | miljodirektoratet.no | Skur 38 |
| Husbanken | husbanken.no | Nedre Sem |

### Programs & Certifications
| Organization | URL | Role |
|--------------|-----|------|
| FutureBuilt | futurebuilt.no | Program framework for most projects |
| BREEAM-NOR | bfreem-nor.no | Certification body |
| DOGA | doga.no | Design awards |
| Enova | enova.no | Funding support |

### Industry & Research
| Organization | URL | Role |
|--------------|-----|------|
| SINTEF | sintef.no | Structural testing |
| Treteknisk | treteknisk.no | Timber testing |
| KS.no | ks.no | Municipal best practices |
| Anskaffelser.no | anskaffelser.no | Public procurement examples |
...
- Architect: MAD Arkitekter - https://mad.no/prosjekter/kristian-august-gate-13/
- Reuse Coordinator: Insenti - https://insenti.no/prosjekt/kristian-augusts-gate-13-ka13/
- Reuse Advisor: Asplan Viak - https://www.asplanviak.no
- Testing: SINTEF - https://www.sintef.no
...
**Primary Sources:**
1. Miljødirektoratet. "Skur 38 - gjenbruk av byggematerialer". Klimasats 2021. https://www.miljodirektoratet.no/ansvarsomrader/klima/for-myndigheter/kutte-utslipp-av-klimagasser/klimasats/2021/skur-38---gjenbruk-av-byggematerialer/
2. Hille Melbye Arkitekter. "Skur 38". https://hmark.no/projects/skur-38/
3. Norske landskapsarkitekters forening. "Skur 38". https://landskapsarkitektur.no/prosjekter/skur-38
4. Open House Oslo. "Havneskuret som ble miljøforbilde". 2024. https://openhouseoslo.no/havneskuret-som-ble-miljoforbilde/
5. IARK. "Oslo Havn / Skur 38". https://iark.no/prosjekter/oslo-havn-skur38
6. Trondheim Kommune. "Skur 38". https://www.trondheim.kommune.no/tema/bygg-kart-og-eiendom/bygging/byarkitekten/arkitekturstrategien/varig2/7holdbar/skur-38/
7. Oslo Havn. "Skur 38 Utleieprospekt". 2020. https://www.oslohavn.no/globalassets/oslo-havn/dokumenter/dokumenter-2020/201124-oslo-havn-skur-38_utleieprospekt.pdf

---

### 3. Eikeli videregående skole

**Primary Sources:**
- FutureBuilt project database
- Viken Fylkeskommune project archives
- HØINE AS supplier documentation
- BREEAM certification records

**Note:** Specific URLs to be verified from FutureBuilt.no
...
### 6. Treklang / Oksenøya Senter

**Primary Sources:**
- Bærum kommune project pages
- FutureBuilt project database
- Veidekke project documentation
...
**Primary Sources:**
- Oslo city council resolution (September 27, 2017)
- Undervisningsbygg Oslo KF archives
...
**Primary Sources:**
- Norsk Folkemuseum documentation
- FutureBuilt. "Norsk Folkemuseum bygger nytt bygg av gammel låve". https://www.futurebuilt.no/Nyheter?page=8#!/Nyheter/Norsk-Folkemuseum-bygger-nytt-bygg-av-gammel-laave
- Sparebankstiftelsen funding documentation
- Treteknisk institutt testing reports

---

### 9. Sirkulær Ressurssentral

**Primary Sources:**
- ressurssentral.no - Official website
- ombygg.no - Online marketplace
- Oslo Miljøpris 2023 documentation

---

### 10. Nøstebukten Brygge

**Primary Sources:**
- Bergen kommune FutureBuilt case study
- FutureBuilt intensjonsavtale (April 2024)
- OBOS/EGD Property documentation
...
### 21. Høyblokken (Nytt Regjeringskvartal)

**Primary Sources:**
1. Statsbygg. "Nytt regjeringskvartal". https://www.statsbygg.no/prosjekter-og-eiendommer/nytt-regjeringskvartal
...
**Primary Sources:**
1. Fremtidens Byggenæring. "Backe Stor-Oslo totalrehabiliterer Lilleborg skole". https://www.fremtidensbygg.no/backe-stor-oslo-totalrehabiliterer-lilleborg-skole/

---

## Industry Publications

| Publication | URL | Coverage |
|-------------|-----|----------|
| Byggeindustrien | byggeindustrien.no | Industry news |
| Arkitektur N | arkitektur.no | Project features |
| Byggfakta Nyheter | byggfaktanyheter.no | Technical documentation |
| Fremtidens Byggenæring | fremtidensbygg.no | Innovation focus |
| Bygg.no | bygg.no | Construction news |

---

## Research Institutions

| Institution | URL | Contribution |
|-------------|-----|--------------|
| SINTEF | sintef.no | Structural testing protocols |
| NTNU | ntnu.no | Academic research |
| Oslo Met | oslomet.no | Building research |
| Treteknisk | treteknisk.no | Timber testing |
